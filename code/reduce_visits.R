...
GeoCohort10 <- read_csv("output/raw/GeoCohort10_2023-02-06.csv")
GeoCohort11 <- read_csv("output/raw/GeoCohort11_2023-02-06.csv")
GeoCohort12 <- read_csv("output/raw/GeoCohort12_2023-02-06.csv")
GeoCohort13 <- read_csv("output/raw/GeoCohort13_2023-02-06.csv")
GeoCohort14 <- read_csv("output/raw/GeoCohort14_2023-02-06.csv")
GeoCohort15 <- read_csv("output/raw/GeoCohort15_2023-02-06.csv")
GeoCohort16 <- read_csv("output/raw/GeoCohort16_2023-02-06.csv")
GeoCohort17 <- read_csv("output/raw/GeoCohort17_2023-02-06.csv")
GeoCohort18 <- read_csv("output/raw/GeoCohort18_2023-02-06.csv")

GeoVisitsc110 <- read_csv("output/raw/GeoVisitsc110_2023-02-06.csv")
GeoVisitsc111 <- read_csv("output/raw/GeoVisitsc111_2023-02-06.csv")
GeoVisitsc112 <- read_csv("output/raw/GeoVisitsc112_2023-02-06.csv")
GeoVisitsc113 <- read_csv("output/raw/GeoVisitsc113_2023-02-06.csv")
GeoVisitsc114 <- read_csv("output/raw/GeoVisitsc114_2023-02-06.csv")
GeoVisitsc115 <- read_csv("output/raw/GeoVisitsc115_2023-02-06.csv")
GeoVisitsc116 <- read_csv("output/raw/GeoVisitsc116_2023-02-06.csv")
GeoVisitsc117 <- read_csv("output/raw/GeoVisitsc117_2023-02-06.csv")
GeoVisitsc118 <- read_csv("output/raw/GeoVisitsc118_2023-02-06.csv")

GeoVisitsc210 <- read_csv("output/raw/GeoVisitsc210_2023-02-06.csv")
GeoVisitsc211 <- read_csv("output/raw/GeoVisitsc211_2023-02-06.csv")
GeoVisitsc212 <- read_csv("output/raw/GeoVisitsc212_2023-02-06.csv")
GeoVisitsc213 <- read_csv("output/raw/GeoVisitsc213_2023-02-06.csv")
GeoVisitsc214 <- read_csv("output/raw/GeoVisitsc214_2023-02-06.csv")
GeoVisitsc215 <- read_csv("output/raw/GeoVisitsc215_2023-02-06.csv")
GeoVisitsc216 <- read_csv("output/raw/GeoVisitsc216_2023-02-06.csv")
GeoVisitsc217 <- read_csv("output/raw/GeoVisitsc217_2023-02-06.csv")
GeoVisitsc218 <- read_csv("output/raw/GeoVisitsc218_2023-02-06.csv")

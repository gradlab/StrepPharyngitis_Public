...
Calculate the proportion of the population represented in the dataset for calculation in methods
```{r pop proportion}
...
Calculate the total visits per 1000 members across all years by region. Because Figure S3a.
```{r Figure S3a}
...
Calculate average visits per year in each region and statistically compare. Becomes Figures S3b and S3c.
```{r supplementary Figure 3b & 3c}
...
Total visits per 1000 members across all years by subregion as well as calculation of average visits per year in each region and statistical comparison. Becomes Supplementary Figure 4.
...
Average subregional differences over the course of the year. Becomes Supplementary Figure 6.
...
Calculate average differences between regions in quarters, becomes Supplementary Table 6 
```{r table S6}
#initialize df
...
T-tests comparing each region-month, becomes Supplementary Figure 7a 
...
T-tests comparing each subregion-month, becomes Supplementary Figure 7b
```{r supplementary figure 7b}
...
Fit sinusoids to region trends and plot. Becomes Supplementary Figure 11. 
```{r regional sinusoids plot, supplementary figure 11}
...
Plot regional sinusoid phases. Becomes Supplementary Figure 11.
...
Fit sinusoids to subregional data and plot. Becomes Supplementary Figure 10a.
...
Plot subregion phases. Becomes Supplementary Figure 10b.
```{r subregion phases, supplementary figure 10b}
...
Calculate subregion centroids. Becomes Supplementary Figure 12. 
```{r centroid analysis figure S12}
...
Calculate distances from each subregion to the centroid and correlate with phases. Becomes Supplementary Figure 12b. 
```{r centroid analysis figure S12b}
...
Load in trimmed school start data, calculate uptick points and plot. Becomes Supplementary Figure 14 and Figure 3.
```{r school start date,fig 3, figS14}
...
Correlate start dates with uptick dates. Becomes Figure S14. 
```{r, correlation fig S14}
...
```
Age analyses, becomes figure S2
```{r, age, figure S2}
...
State-level school start analysis. Supplemental figures 15-16. 
```{r, figures S15, S16}
...
write_csv(memb_vis_prop_table, '/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/output/agegroup_breakdown.csv')
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/fig1.tiff", points_region_plot, width = 7, height =5, dpi = 300)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/fig1_hr.tiff", points_region_plot, width = 7, height =5, dpi = 1000)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/fig2.tiff", state_phases_map_noSC, width = 7, height = 5, dpi = 300)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/fig2_hr.tiff", state_phases_map_noSC, width = 7, height = 5, dpi = 1000)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/fig3.tiff", uptickdates_plot, width =7, height =5, dpi = 300)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/fig3_hr.tiff", uptickdates_plot, width =7, height =5, dpi = 1000)
...
#fig S2
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS2a.pdf", membership_freq_plot, width = 5, height = 3.5)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS2a.png", membership_freq_plot, width = 5, height = 3.5)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS2.pdf", grid.arrange(membership_freq_plot, age_breakdown_plot, age_month_plot, layout_matrix = rbind(c(1,1,1,2,2,2),c(1,1,1,2,2,2), c(4,3,3,3,3,4),c(4,3,3,3,3,4))), width = 7, height = 6)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS2.png", grid.arrange(membership_freq_plot, age_breakdown_plot, age_month_plot, layout_matrix = rbind(c(1,1,1,2,2,2),c(1,1,1,2,2,2), c(4,3,3,3,3,4),c(4,3,3,3,3,4))), width = 7, height = 6)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS2.tiff", grid.arrange(membership_freq_plot, age_breakdown_plot, age_month_plot, layout_matrix = rbind(c(1,1,1,2,2,2),c(1,1,1,2,2,2), c(4,3,3,3,3,4),c(4,3,3,3,3,4))), width = 7, height = 6, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS3.tiff", grid.arrange(region_differences_byyear_forfig, year_averages_plot, region_comparisons, layout_matrix = rbind(c(1,1,1,2,2,2),c(1,1,1,2,2,2), c(4,3,3,3,3,4),c(4,3,3,3,3,4))), width = 7, height = 6, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS4.tiff", grid.arrange(subregion_differences_byyear_forfig, year_averages_plot_subregions, ncol = 2, layout_matrix = rbind(c(1,1,1,2,2,2,2))),  width = 8, height = 4, dpi = 300)
#fig S5
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS5.tiff", grid.arrange(region_quarters_plot, subregion_quarters_plot), width = 7, height = 10, dpi = 300)
#fig S6
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS6.tiff", points_subregion_plot, width = 7, height = 5, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS7.tiff", grid.arrange(region_heatmap_significance_noredund, subregion_heatmap_significance_noredund), width = 7, height = 11, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS8.png",
       grid.arrange(under_19_monthly_vis_plot_nolegend, over_19_monthly_vis_plot, ncol =2, layout_matrix =rbind(c(1,1,1,1,2,2,2,2,2,2))), width =8, height = 4)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS8.tiff",
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS9.tiff", state_sinusoids_subregions  + theme(axis.text.x = element_blank()), width =8.5, height =6, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS10.tiff", grid.arrange(subregion_sinusoids_CIs_plot_points, subregion_phase_plot), width = 7, height = 9, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS11.tiff", grid.arrange(region_sinusoids_CIs_plot_points, region_phase_plot), width = 7, height = 9, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS12.png", grid.arrange(subregion_centroids_plot, subregion_phase_dist_correlation_forfig, ncol = 1), width = 7.5, height = 9)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS12.pdf", grid.arrange(subregion_centroids_plot, subregion_phase_dist_correlation_forfig, ncol = 1), width = 7.5, height = 9)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS12.tiff", grid.arrange(subregion_centroids_plot, subregion_phase_dist_correlation_forfig, ncol = 1), width = 7.5, height = 9, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS13.pdf", grid.arrange(state_centroid_map, state_distance_correlation_plot), width = 7.5, height = 9)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS13.png", grid.arrange(state_centroid_map, state_distance_correlation_plot), width = 7.5, height = 9)
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS13.tiff", grid.arrange(state_centroid_map, state_distance_correlation_plot), width = 7.5, height = 9, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS14_unedited.tiff", grid.arrange(subregion_uptick_plot, corrplot_schoolstart, ncol = 1), width = 7, height = 9, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS15.tiff", state_uptick_plot, width = 8.5, height = 6, dpi = 300)
#fig S16
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS16.tiff", grid.arrange(state_correlation_plot, state_errorbars, ncol = 1), width = 7, height = 10, dpi = 300)
...
ggsave("/Users/madeleinekline/Dropbox (Harvard University)/GradLab/StrepPharyngitis/figures/figS17.tiff",threeagegroup_plot, width = 7, height = 5, dpi = 300)
